...
const mapColors = (colors: string[]) => colors.map((hex, idx) => ({ name: `Cor ${idx + 1}`, hex }));
...
export const products: Product[] = [
  {
    ...
    category: "Vestidos",
    colors: mapColors(["#FFB6D9", "#E8D5F2", "#FFE5EC", "#B8E6F5"]),
    sizes: ["P", "M", "G", "GG"],
  ...
  },
  {
    ...
    category: "Conjuntos",
    colors: mapColors(["#FFD6E8", "#E5D4F7", "#FFF0E5"]),
    sizes: ["1", "2", "3", "4"],
  ...
  },
  {
    ...
    category: "Calçados",
    colors: mapColors(["#FFB8D1", "#C5A3E8", "#FFE8F0"]),
    sizes: ["15", "16", "17", "18"],
  ...
  },
  {
    ...
    category: "Bodies",
    colors: mapColors(["#FFE5EC", "#FFF0E5", "#F0E5FF"]),
    sizes: ["RN", "P", "M", "G"],
  ...
  },
  {
    ...
    category: "Macacões",
    colors: mapColors(["#E8D5F2", "#FFD6E8", "#B8E6F5", "#FFE8F0"]),
    sizes: ["1", "2", "3", "4"],
  ...
  },
  {
    ...
    category: "Acessórios",
    colors: mapColors(["#FFB6D9", "#E8D5F2", "#FFE5EC", "#C5A3E8", "#FFF0E5"]),
    sizes: ["Único"],
  ...
  },
  {
    ...
    category: "Saias",
    colors: mapColors(["#FFD6E8", "#E5D4F7", "#FFE8F0", "#B8E6F5"]),
    sizes: ["2", "4", "6", "8"],
  ...
  },
  {
    ...
    category: "Pijamas",
    colors: mapColors(["#FFE5EC", "#E8D5F2", "#FFF0E5"]),
    sizes: ["1", "2", "3", "4"],
  ...
  },
  {
    ...
    category: "Acessórios",
    colors: mapColors(["#FFB6D9", "#FFE5EC", "#E8D5F2", "#FFF0E5"]),
    sizes: ["Único"],
  ...
  },
  {
    ...
    category: "Conjuntos",
    colors: mapColors(["#E8D5F2", "#FFD6E8", "#B8E6F5"]),
    sizes: ["2", "4", "6", "8"],
  ...
  },
  {
    ...
    category: "Acessórios",
    colors: mapColors(["#FFB6D9", "#E8D5F2", "#FFE5EC"]),
    sizes: ["P", "M", "G"],
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1503944583220-79d8926ad5e2?w=500&h=500&fit=crop",
    category: "Casacos",
    colors: mapColors(["#FFD6E8", "#E8D5F2", "#FFF0E5", "#B8E6F5"]),
    sizes: ["2", "4", "6", "8"],
